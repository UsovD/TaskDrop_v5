  ...
  return (0, import_jsx_runtime27.jsxs)("section", _object_spread_props(_object_spread({
    ...
    children: [
      ...
      onCloseIcon && (0, import_jsx_runtime27.jsxs)(Tappable, {
        ...
        Component: "div",
        children: [
          !hasBackground && (platform2 === "ios" ? (0, import_jsx_runtime27.jsx)(Icon24Cancel, {}) : (0, import_jsx_runtime27.jsx)(Icon28Close, {})),
...
var Navigation = ({ className, children }) => {
  ...
  return (0, import_jsx_runtime49.jsxs)("div", {
    ...
    children: [
      ...
      (!hasChildren || platform2 === "ios") && (0, import_jsx_runtime49.jsx)(Icon16Chevron, {
      ...
      (0, import_jsx_runtime59.jsxs)("div", {
        ...
        children: [
          ...
          (0, import_jsx_runtime59.jsx)("div", {
            ...
            children: import_react25.Children.map(children, (child, index2) => (0, import_jsx_runtime59.jsxs)(import_jsx_runtime59.Fragment, {
              children: [
                child,
                index2 < import_react25.Children.count(children) - 1 && (0, import_jsx_runtime59.jsx)(Divider, {
...
var FormInput = (0, import_react31.forwardRef)((_param, ref) => {
  ...
  return (0, import_jsx_runtime76.jsxs)("div", {
    ...
    children: [
      ...
      hasReactNode(header) && platform2 === "base" && (0, import_jsx_runtime76.jsx)(FormInputTitle, {
...
var MultiselectBase = (0, import_react36.forwardRef)((_param, ref) => {
  ...
  return (
    ...
    (0, import_jsx_runtime84.jsxs)("div", {
      ...
      children: [
        chipsValue.map((option, index2) => (0, import_jsx_runtime84.jsx)(import_react36.Fragment, {
          children: renderChip({
...
var FloatingArrow = (0, import_react38.forwardRef)((_param, ref) => {
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Overlays/Popper/Popper.js
var Popper = (0, import_react40.forwardRef)((_param, ref) => {
  var {
  ...
  const [arrowRef, setArrowRef] = (0, import_react40.useState)(null);
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Form/Multiselect/components/MultiselectDropdown/MultiselectDropdown.js
var MultiselectDropdown = (0, import_react41.forwardRef)(({ dropdownAriaId, options, onMouseLeave, targetRef, addOptionFromInput, setFocusedOptionIndex, renderOption = renderOptionDefault, focusedOption, value, setOptionNode, setOpened, closeDropdownAfterSelect, addOption, focusedOptionIndex, clearInput }, ref) => {
  return (0, import_jsx_runtime91.jsx)(Popper, {
    ...
    children: options.map((option, index2) => {
      ...
      return (0, import_jsx_runtime91.jsx)(import_react41.Fragment, {
...
var getTextFromChildren = (children) => {
  if (!(children instanceof Array) && !(0, import_react42.isValidElement)(children)) {
    return childToString(children);
  }
  return import_react42.Children.toArray(children).reduce((text, child) => {
    let newText = "";
    const isValidElementResult = (0, import_react42.isValidElement)(child);
...
function useCustomEnsuredControl({ value, defaultValue, disabled, onChange: onChangeProp }) {
  ...
  const [localValue, setLocalValue] = (0, import_react43.useState)(defaultValue);
  const preservedControlledValueRef = (0, import_react43.useRef)();
  useEnhancedEffect(() => {
    preservedControlledValueRef.current = value;
  });
  const onChange = (0, import_react43.useCallback)((nextValue) => {
    if (disabled) {
      return;
    }
...
var useMultiselectInput = ({ disabled, value: valueProp, onChange, defaultValue = [], inputValue: inputValueProp = "", onInputChange }) => {
  ...
  const [inputValue, setInputValue] = (0, import_react44.useState)(inputValueProp);
  const toggleOption = (0, import_react44.useCallback)((nextValueProp, isNewValue) => {
  ...
  const clearInput = (0, import_react44.useCallback)(() => {
    simulateReactInput(inputRef.current, "");
  }, [
    inputRef
  ]);
  const addOption = (0, import_react44.useCallback)((newValue) => toggleOption(newValue, true), [
    toggleOption
  ]);
  const removeOption = (0, import_react44.useCallback)((newValue) => {
    toggleOption(newValue, false);
  }, [
    toggleOption
  ]);
  const addOptionFromInput = (0, import_react44.useCallback)((inputValueToAdd) => {
  ...
  const inputChange = (0, import_react44.useCallback)((event) => {
...
var useMultiselect = ({
  ...
  const [opened, setOpened] = (0, import_react45.useState)(false);
  const [options, setOptions] = (0, import_react45.useState)(() => opened ? transformOptions({
    value,
    inputValue,
    emptyText,
    creatable,
  ...
  const [focusedOptionIndex, setFocusedOptionIndex] = (0, import_react45.useState)(0);
  const [focusedOption, setFocusedOption] = (0, import_react45.useState)(null);
  const handleInputChange = (0, import_react45.useCallback)((event) => {
    onInputChange(event);
    if (!opened) {
      return;
    }
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Form/Multiselect/Multiselect.js
var Multiselect = (0, import_react46.forwardRef)((_param, ref) => {
  var {
    // FormInput options
    header,
    before,
  ...
  const dropdownAriaId = (0, import_react46.useId)();
  const dropdownScrollBoxRef = (0, import_react46.useRef)(null);
  const handleFocus = () => {
    setOpened(true);
  ...
  const optionsNodes = (0, import_react46.useRef)([]).current;
  ...
  const onDropdownMouseLeave = (0, import_react46.useCallback)(() => {
    setFocusedOptionIndex(null);
  }, [
    setFocusedOptionIndex
  ]);
...
var PinInputCell = (0, import_react47.forwardRef)((_param, ref) => {
...
var usePinInput = ({ pinCount, value: valueProp = [], onChange }) => {
  const inputRefs = (0, import_react48.useRef)([]).current;
  const [value, setValue] = useCustomEnsuredControl({
  ...
  const handleClickValue = (0, import_react48.useCallback)((enteredValue) => {
  ...
  const handleClickBackspace = (0, import_react48.useCallback)(() => {
    removeLastValue(value.length - 1);
  }, [
    value
  ]);
  const handleButton = (0, import_react48.useCallback)((index2, button) => {
  ...
  const setInputRefByIndex = (0, import_react48.useCallback)((index2, ref) => {
    if (!ref) {
      return;
    }
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Form/PinInput/PinInput.js
var PIN_MIN_COUNT = 2;
var PinInput = (0, import_react49.forwardRef)((_param, ref) => {
        ...
        (0, import_jsx_runtime101.jsxs)("header", {
          ...
          children: [
            ...
            (0, import_jsx_runtime101.jsx)("div", {
              ...
              }).map((_, index2) => (0, import_jsx_runtime101.jsx)(PinInputCell, {
...
var Selectable = (_param) => {
  ...
  return (0, import_jsx_runtime110.jsxs)("label", {
    ...
    children: [
      ...
      platform2 === "ios" && (0, import_jsx_runtime110.jsx)(IconSelectableIOS, {
        className: "tgui-ad96577f259c5732",
        "aria-hidden": true
      }),
      platform2 === "base" && (0, import_jsx_runtime110.jsx)(IconSelectableBase, {
        className: "tgui-ad96577f259c5732",
        "aria-hidden": true
      })
    ]
...
function useEventListener(event, _cb, _options) {
  const cbRef = (0, import_react50.useRef)(_cb);
  useEnhancedEffect(() => {
    cbRef.current = _cb;
  }, [
    _cb
  ]);
  const cb = (0, import_react50.useCallback)((e) => cbRef.current && cbRef.current(e), []);
  const detach = (0, import_react50.useRef)(() => {
  });
  ...
  const add = (0, import_react50.useCallback)((el) => {
    if (!canUseDOM) {
      return;
    }
    remove();
  ...
  (0, import_react50.useEffect)(() => remove, [
    remove
  ]);
...
var Touch = (_param) => {
  ...
  const events = (0, import_react51.useMemo)(getSupportedEvents, []);
  const didSlide = (0, import_react51.useRef)(false);
  const gesture = (0, import_react51.useRef)(null);
  ...
  const containerRef = (0, import_react51.useRef)();
  useEnhancedEffect(() => {
...
var SliderThumb = (0, import_react52.forwardRef)((_param, ref) => {
...
var useSlider = (_param) => {
  ...
  const [localValue, setValue] = (0, import_react53.useState)(defaultValue);
  ...
  const gesture = (0, import_react53.useRef)({
    dragging: null,
    startX: 0,
    containerWidth: 0
  }).current;
  const thumbsContainerRef = (0, import_react53.useRef)(null);
  const thumbStartInputRef = (0, import_react53.useRef)(null);
  const thumbEndInputRef = (0, import_react53.useRef)(null);
...
var Tabbar = (_param) => {
  ...
  return (0, import_jsx_runtime119.jsx)(FixedLayout, _object_spread_props(_object_spread({
    className: classNames("tgui-53cb2ebed0c3b08f", platform2 === "ios" && "tgui-a2b4713d67582227", className)
  }, restProps), {
    children
  }));
};
...
var Breadcrumbs = ({ divider = "dot", className, children }) => (0, import_jsx_runtime123.jsx)("div", {
  ...
  children: import_react54.Children.map(children, (child, index2) => (0, import_jsx_runtime123.jsxs)(import_jsx_runtime123.Fragment, {
    children: [
      child,
      index2 !== import_react54.Children.count(children) - 1 && (0, import_jsx_runtime123.jsxs)("div", {
...
var Slot = React9.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime135.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React9.isValidElement(newElement) ? React9.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime135.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
});
...
var Slottable = ({ children }) => {
  return (0, import_jsx_runtime135.jsx)(import_jsx_runtime135.Fragment, { children });
};
...
var Primitive = NODES.reduce((primitive, node) => {
  const Node2 = React10.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime136.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
...
var DismissableLayerBranch = React12.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime137.jsx)(Primitive.div, { ...props, ref: composedRefs });
});
...
var FocusScope = React13.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime138.jsx)(Primitive.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
var Portal = React14.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom5.default.createPortal((0, import_jsx_runtime139.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var Slot2 = React27.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime140.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React27.isValidElement(newElement) ? React27.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime140.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children });
});
Slot2.displayName = "Slot";
var SlotClone2 = React27.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
var Slottable2 = ({ children }) => {
  return (0, import_jsx_runtime140.jsx)(import_jsx_runtime140.Fragment, { children });
};
function isSlottable2(child) {
  return React27.isValidElement(child) && child.type === Slottable2;
}
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime141.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React28.Children.map(children, (child) => (0, import_jsx_runtime141.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime141.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlay = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.modal ? (0, import_jsx_runtime141.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime141.jsx)(DialogOverlayImpl, { ...overlayProps, ref: forwardedRef }) }) : null;
  }
);
...
var DialogOverlayImpl = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime141.jsx)(Combination_default, { as: Slot2, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime141.jsx)(
        Primitive.div,
        {
          "data-state": getState(context.open),
          ...overlayProps,
...
var DialogContent = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime141.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime141.jsx)(DialogContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime141.jsx)(DialogContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var DialogContentImpl = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime141.jsxs)(import_jsx_runtime141.Fragment, { children: [
      ...
      (0, import_jsx_runtime141.jsxs)(import_jsx_runtime141.Fragment, { children: [
        (0, import_jsx_runtime141.jsx)(TitleWarning, { titleId: context.titleId }),
        (0, import_jsx_runtime141.jsx)(DescriptionWarning, { contentRef, descriptionId: context.descriptionId })
      ] })
    ] });
  }
);
...
var DialogTitle = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime141.jsx)(Primitive.h2, { id: context.titleId, ...titleProps, ref: forwardedRef });
  }
);
...
var DialogDescription = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime141.jsx)(Primitive.p, { id: context.descriptionId, ...descriptionProps, ref: forwardedRef });
  }
);
...
var ModalClose = (props) => (0, import_jsx_runtime142.jsx)(Drawer.Close, _object_spread({
  asChild: true
}, props));
...
var ModalHeader = (0, import_react61.forwardRef)((_param, ref) => {
  ...
  const platform2 = usePlatform();
  return (0, import_jsx_runtime143.jsxs)("header", _object_spread_props(_object_spread({
    ref,
    ...
    children: [
      ...
      platform2 === "ios" && (0, import_jsx_runtime143.jsx)(Text, {
        weight: "2",
...
var ModalOverlay = (0, import_react62.forwardRef)((_param, ref) => {
  ...
  return (0, import_jsx_runtime144.jsx)(Drawer.Overlay, _object_spread({
    ref,
...
var Modal = (0, import_react63.forwardRef)((_param, ref) => {
  var { overlayComponent = (0, import_jsx_runtime145.jsx)(ModalOverlay, {}), open, onOpenChange, header, className, children, nested, trigger, closeThreshold, scrollLockTimeout, snapPoints, fadeFromIndex, modal, preventScrollRestoration, dismissible } = _param, restProps = _object_without_properties(_param, [
    "overlayComponent",
    "open",
    "onOpenChange",
    "header",
  ...
  return (0, import_jsx_runtime145.jsxs)(Component, {
    open,
    onOpenChange,
    closeThreshold,
    scrollLockTimeout,
    ...
    dismissible,
    children: [
      trigger && (0, import_jsx_runtime145.jsx)(Drawer.Trigger, {
        asChild: true,
        children: trigger
      }),
      (0, import_jsx_runtime145.jsxs)(Drawer.Portal, {
        container: portal,
        children: [
          overlayComponent,
          (0, import_jsx_runtime145.jsxs)(Drawer.Content, _object_spread_props(_object_spread({
            ref,
...
var Tooltip = (_param) => {
  ...
  return (0, import_jsx_runtime146.jsx)(Popper, _object_spread_props(_object_spread({
    withArrow: true,
    ...
    children: (0, import_jsx_runtime146.jsx)(Caption, {
      level: "1",
      children
    })
  }));
...
var AppRoot = (0, import_react67.forwardRef)((_param, ref) => {
  ...
  return (0, import_jsx_runtime147.jsx)("div", _object_spread_props(_object_spread({
    ...
    children: (0, import_jsx_runtime147.jsx)(AppRootContext.Provider, {
      value: contextValue,
      children
    })
  }));
